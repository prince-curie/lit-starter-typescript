...
This is a version of the template that updates all dependencies to a newer version and uses Lit 3.3.2, thereby eliminating all vulnerabilities currently existing in the official template. I have also migrated the eslint configuration.
